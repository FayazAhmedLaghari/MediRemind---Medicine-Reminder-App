...
abstract class AppLocalizations {
  ...
  /// No description provided for @medicineInteraction.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @markedCompleted.
  ///
  /// In en, this message translates to:
  /// **'Marked as completed'**
  ...
  /// No description provided for @medicineInteractionsTitle.
  ///
  /// In en, this message translates to:
  /// **'Medicine Interactions'**
  String get medicineInteractionsTitle;

  /// No description provided for @refillRemindersTitle.
  ///
  /// In en, this message translates to:
  /// **'Refill Reminders'**
  String get refillRemindersTitle;
  ...
  /// No description provided for @refillsNeeded.
  ///
  /// In en, this message translates to:
